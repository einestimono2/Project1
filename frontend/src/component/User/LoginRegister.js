  ...
  const validate = (e) => {
    ...
    setErrors((prev) => {
      ...
      switch (name) {
        case "loginEmail":
          if (!value) {
            stateObj[name] = "Email không được để trống.";
          } else if (!/\S+@\S+\.\S+/.test(value)) {
            stateObj[name] = "Địa chỉ email không hợp lệ.";
          }
          break;

        case "loginPassword":
          if (!value) {
            stateObj[name] = "Password không được để trống.";
          }
          break;
        ...
        case "password":
          if (!value) {
            ...
            stateObj[name] = "Password quá ngắn.";
          } else if (user.confirmPassword && value !== user.confirmPassword) {
            stateObj["confirmPassword"] = "Confirm Password không khớp.";
          } else {
        ...
        case "confirmPassword":
          if (!value) {
            stateObj[name] = "Confirm Password không được để trống.";
          } else if (user.password && value !== user.password) {
            stateObj[name] = "Confirm Password không khớp.";
          }
          break;
