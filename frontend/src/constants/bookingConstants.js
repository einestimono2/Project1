...
export const ALL_BOOKING_USERS_REQUEST = "ALL_BOOKING_USERS_REQUEST";
export const ALL_BOOKING_USERS_SUCCESS = "ALL_BOOKING_USERS_SUCCESS";
export const ALL_BOOKING_USERS_FAIL = "ALL_BOOKING_USERS_FAIL";

export const STATISTIC_BOOKINGS_REQUEST = "STATISTIC_BOOKINGS_REQUEST";
export const STATISTIC_BOOKINGS_SUCCESS = "STATISTIC_BOOKINGS_SUCCESS";
export const STATISTIC_BOOKINGS_FAIL = "STATISTIC_BOOKINGS_FAIL";
