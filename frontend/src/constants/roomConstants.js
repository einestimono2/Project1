...
export const STATISTIC_ROOM_REQUEST = "STATISTIC_ROOM_REQUEST";
export const STATISTIC_ROOM_SUCCESS = "STATISTIC_ROOM_SUCCESS";
export const STATISTIC_ROOM_FAIL = "STATISTIC_ROOM_FAIL";
