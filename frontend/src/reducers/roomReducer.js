...
export const roomStatisticsReducer = (state = { statistics: {} }, action) => {
  switch (action.type) {
    case STATISTIC_ROOM_REQUEST:
      return {
        loading: true,
        ...state,
      };

    case STATISTIC_ROOM_SUCCESS:
      return {
        loading: false,
        rooms: action.payload.rooms,
...
export const myRoomsReducer = (state = { rooms: [] }, action) => {
  switch (action.type) {
